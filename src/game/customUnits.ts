...
export const INSPECTION_RULES = { radius: 3, seconds: 3, maxRank: 2, rankBonus: .1 } as const;
export const INSPECTION_HELP = 'George is an autonomous civilian and cannot be selected or commanded. He wanders, pauses near friendly infantry or vehicles for 3 seconds to inspect them, then resumes walking. Inspections never upgrade units. George never attacks.';
