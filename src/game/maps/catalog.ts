...
export const MAP_CATALOG: readonly MapCatalogEntry[] = [
  ...
  { id: 'saffron-wash', name: 'Saffron Wash', path: '/maps/saffron-wash.map', players: 6, size: [96, 96], theater: 'TEMPERATE', style: 'Dry wash', description: 'Braided rough-ground washes cross a sandy plain. Six expansive starting plots surround a contested oasis.' },
  ...
  { id: 'copperhead-mesa', name: 'Copperhead Mesa', path: '/maps/copperhead-mesa.map', players: 6, size: [96, 96], theater: 'TEMPERATE', style: 'Mineral plain', description: 'Concentric mineral bands and sandy shelves form a flat, buildable mesa. Radial approaches lead to central tech.' },
