...
export interface InfantryTimings {
  [unit: string]: InfantryAnimationDefinition;
}

export const NATIVE_EFFECT_TIMINGS: EffectTimings = {
...
export const NATIVE_INFANTRY_TIMINGS: InfantryTimings = {
  ...
  tany: {
    fireFrame: 3,
    sequences: {
      FireUp: { frames: 6, ticksPerFrame: 1 },
      WetAttack: { frames: 6, ticksPerFrame: 1 },
    },
  },
  ...
  gi: {
    ...
    sequences: {
      FireUp: { frames: 6, ticksPerFrame: 1 },
      DeployedFire: { frames: 6, ticksPerFrame: 1 },
      Deploy: { frames: 15, ticksPerFrame: 1 },
      Undeploy: { frames: 2, ticksPerFrame: 1 },
      Idle1: { frames: 15, ticksPerFrame: 3, normalized: true, facing: 4 },
      Idle2: { frames: 14, ticksPerFrame: 3, normalized: true, facing: 6 },
    },
  },
  cons: {
    fireFrame: 6,
    sequences: {
      FireUp: { frames: 6, ticksPerFrame: 1 },
      Idle1: { frames: 15, ticksPerFrame: 3, normalized: true, facing: 2 },
      Idle2: { frames: 14, ticksPerFrame: 3, normalized: true, facing: 6 },
    },
  },
  engineer: {
