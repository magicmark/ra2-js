...
export class UI {
  ...
  constructor(private game: GameAPI, private actions: UIActions, options: { mobile?: boolean; assetSource?: string } = {}) {
    ...
    this.root.innerHTML = `
      ...
      <nav class="mobile-commandbar editorial-commandbar" aria-label="Mobile commands">
        <div class="editorial-masthead" aria-hidden="true"><b>FIELD / COMMAND</b><span>TACTICAL INDEX — 05</span></div>
        <button class="active" data-mode="select" aria-label="Select units mode; cancel building placement" aria-pressed="true"><small aria-hidden="true">01</small><span>Select</span></button>
        <button data-mode="pan" aria-label="Pan camera mode" aria-pressed="false"><small aria-hidden="true">02</small><span>Pan</span></button>
        <button data-mode="attack" aria-label="Attack move mode" aria-pressed="false"><small aria-hidden="true">03</small><span>Attack</span></button>
        <button data-action="stop" aria-label="Stop selected units"><small aria-hidden="true">04</small><span>Stop</span></button>
        <button class="mobile-build-button" data-action="build-toggle" aria-label="Build panel" aria-controls="build-sidebar" aria-expanded="false"><small aria-hidden="true">05</small><span>Build<span class="editorial-arrow" aria-hidden="true">↗</span></span><i id="mobile-ready-dot" aria-hidden="true"></i></button>
      </nav>
